...
class ConfigUtil(path: String) extends Serializable {
  ...
  /**
    *
    */
  val recoderDevDuplicate:String=getConfigSetting("recoderDevDuplicate","")


  val recoderSSIDDuplicate:String=getConfigSetting("recoderSSIDDuplicate","")
  val recoderAPDuplicate:String=getConfigSetting("recoderAPDuplicate","")
  /**
    *redis host
   */
